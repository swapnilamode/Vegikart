    ...
    return(
        <div className="p-3 md:py-8">
            <div className="w-full max-w-sm bg-white m-auto flex-col p-4">
                ...
                <p className="text-left text-sm -mt-2">Do you want to login as a vendor ? <Link to={"/vlogin"} className="text-red-500 underline">Vendor Login</Link></p>
                <p className="text-left text-sm text-sm -mt-2 py-3">Don't have an account ?{" "} <Link to={"/signup"} className="text-red-500 underline">Sign Up</Link></p>
            </div>
        </div>
